...
:::note[Перед началом]
**Урок 6 из 9 · 30–35 минут**

**Нужно знать:** функции и циклы. **После урока:** сможете читать элементы по индексам, строить новый массив и применять основные методы массивов и строк.
:::
...
Измените `doubleNumbers`, чтобы функция утраивала значения. Затем добавьте условие и сохраняйте в `result` только положительные результаты. Проверьте, что исходный массив не изменился.

## Самостоятельная практика: Reversed Strings
